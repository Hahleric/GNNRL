...
class GCNAgent:
    ...
    def __init__(self, cache_size, feature_dim, batch_size, learning_rate=0.000001, gamma=0.99, buffer_size=1000):
        """
    ...
    def get_action(self, state, edge_index, edge_attr, eps=0.1):
        """
