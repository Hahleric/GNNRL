...
class Environment():
    def __init__(self, cache_size, popular_file):
        """
        ...
        self.init_state = self.state.copy() + popular_file[:, :self.cache_size]
    ...
    def reset(self):
        return self.init_state, self.init_remaining_content
