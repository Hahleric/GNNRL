...
class Environment():
    def __init__(self, args, cache_size, popular_file):
        """
        ...
        self.reward = 0
        self.cached_files = []
        self.init_n_veh = self.args.batch_size
        ...
        self.init_state = np.zeros((1, 136710))
        self.state = self.init_state.copy()

    def step(self, action, rsu_embedding, request_dataset, v2i_rate, print_step):
        """
