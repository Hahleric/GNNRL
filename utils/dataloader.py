...
class Dataloader(object):
    def __init__(self, args, data, device):
        ...
        self.test_dic, self.dataloader_test, self.test_items = self.read_test(self.test_path)
    ...
    def read_test(self, path):
        ...
        items = []
        for user, item_list in dic_test.items():
            for item in item_list:
                items.append(item)
        return dic_test, dataloader, list(items)
