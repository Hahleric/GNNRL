...
def parse_args():
    ...
    parser.add_argument('--k_list', default = 4000, type = int,
    ...
    parser.add_argument('--vehicle_num', default = 41, type = int,
                        help = 'vehicle number')
    parser.add_argument('--feature_dim', default = 4000, type = int,
    ...
    parser.add_argument('--hidden_dim', default = 4000, type = int,
                        help = 'feature dimension')
