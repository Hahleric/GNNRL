...
def parse_args():
    ...
    parser.add_argument('--k_list', default = 5863, type = int,
    ...
    parser.add_argument('--cache_size', default =2000, type = int,
                        help = 'cache size for cache environment')
    parser.add_argument('--vehicle_num', default = 41, type = int,
                        help = 'vehicle number')
    parser.add_argument('--feature_dim', default = 5863, type = int,
    ...
    parser.add_argument('--hidden_dim', default = 5863, type = int,
                        help = 'feature dimension')
